...
public class XMLCreatorFootnotes extends javax.swing.JDialog {

    public XMLCreatorFootnotes(java.awt.Frame parent) {
        super(parent);
        initComponents();
        getRootPane().setDefaultButton(jButton1);
    }

    @Action public void closeFootnoteEditor() {
        dispose();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(xmlcreator.XMLCreatorApp.class).getContext().getResourceMap(XMLCreatorFootnotes.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(xmlcreator.XMLCreatorApp.class).getContext().getActionMap(XMLCreatorFootnotes.class, this);
        closeButton.setAction(actionMap.get("closeFootnoteEditor")); // NOI18N
